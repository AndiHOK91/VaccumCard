      ...
      case 'cleaning': {
        return html`
          <div class="toolbar">
            ...
            >
              <ha-icon slot="start" icon="hass:pause"></ha-icon>
            ...
            >
              <ha-icon slot="start" icon="hass:stop"></ha-icon>
            ...
            >
              <ha-icon slot="start" icon="hass:home-map-marker"></ha-icon>
      ...
      case 'paused': {
        return html`
          <div class="toolbar">
            ...
            >
              <ha-icon slot="start" icon="hass:play"></ha-icon>
...
window.customCards.push({
  ...
  documentationURL: 'https://github.com/AndiHOK91/VaccumCard',
