...
> Home Assistant 2026.9 compatible edition maintained by
> [AndiHOK91](https://github.com/AndiHOK91). It is based on the original
> [vacuum-card](https://github.com/denysdovhan/vacuum-card) by Denys Dovhan and
> includes the redesigned visual editor from upstream PR
> [#1185](https://github.com/denysdovhan/vacuum-card/pull/1185).

This edition replaces deprecated Material Web Components in the visual editor
and toolbar with Home Assistant's current `ha-form`, selectors and `ha-button`
components. The card type remains `custom:vacuum-card`, so existing YAML
...
Add `https://github.com/AndiHOK91/VaccumCard` as a custom HACS repository of
type **Dashboard**, then install `Vacuum Card`. Do not install this edition and
the original card at the same time because both register
`custom:vacuum-card`.
...
[latest-release]: https://github.com/AndiHOK91/VaccumCard/releases/latest
[ha-scripts]: https://www.home-assistant.io/docs/scripts/
[edit-readme]: https://github.com/AndiHOK91/VaccumCard/edit/main/README.md
